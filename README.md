<div align="center">
  ...
  <p><b>Java Full Stack Dev | Builder | Mumbai </b></p>
  <p>Building things that matter</p>
  
  <img src="https://komarev.com/ghpvc/?username=itzakankshagupta&color=blueviolet&style=for-the-badge&label=Profile+Views" alt="Profile Views" />
  <a href="https://linkedin.com/in/akanksha-gupta-602323373" target="_blank">
...
```javascript
const akanksha = {
    education    : "B.Tech AI & Data Science @ Mumbai University",
    role         : "Java Full Stack Developer",
    learning     : ["MERN Stack", "Machine Learning"],
    building     : ["Virtual Banking System 🏦", "Aryavarta EV Connect 🚗", "Sree AI 🤖"],
    stack        : ["Java", "Spring Boot", "React", "JavaScript", "SQL", "MongoDB"],
    achievements : [
        "🏆 Google AI & Prompting Essentials Certifications",
